...
// discardPile class
// 1. select()함수를 재정의한다. 
//    : 클릭하면 this와 deck를 제외한 다른 pile에 최상위 카드를 넘긴다.(받을 수 있을 경우에 한해서)
// 2. display()함수를 재정의한다.
...
//    : 최상위 카드가 앞면이면 자신과 deck, discard를 제외한 모든 pile에 최상위 카드를 넘긴다.(받을 수 있을 경우에 한해서)
